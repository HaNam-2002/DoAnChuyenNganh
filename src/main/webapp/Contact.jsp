...
<div class="content">
  <div class="contact">
    ...
    <div class="form">
      ...
      <form action="">
        <div class="flex-rev">
          <input type="text" placeholder="Hà Nam" name="name" id="name" />
          <label for="name">Full Name</label>
        </div>
        <div class="flex-rev">
          <input type="email" placeholder="namvuha2k2@gmail.com" name="email" id="email" />
          <label for="email">Your Email</label>
        </div>
        <div class="flex-rev">
          <input type="text" placeholder="+8423..." name="phone" id="phone" />
          <label for="text">Phone</label>
        </div>
        <div class="flex-rev">
          <textarea placeholder="I have a problem...." name="message" id="message" /></textarea>
          <label for="message">Message</label>
        </div>
        <a href="home" class="csw-btn-button"  >Send</a>
      </form>
    </div>
  </div>
</div>
